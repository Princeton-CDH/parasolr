...
try:
    ...
    from parasolr.management.commands import index, solr_schema
except ImportError:
    pass
...
class TestSolrSchemaCommand:
    ...
    def test_handle_core(self, mockinput, mocksolrschema, mocksolrclient):
        ...
        mockinput.assert_called_with(
            "Solr core %s does not exist. Create it? (y/n) " % mocksolr.collection
        )
        ...
        with override_settings(
            SOLR_CONNECTIONS={"default": {"CONFIGSET": "test_config"}}
        ):
...
class TestIndexCommand:
    ...
    def test_handle_index_by_id(self, mocksolr, mockindexable):
        ...
        mockindexable.all_indexables.return_value = [mock_indexable_model]
