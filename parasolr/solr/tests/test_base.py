...
class TestClientBase:
    ...
    def test_make_request(self, mocksend):
        client_base = ClientBase()
        client_base.session.headers = {"foo": "bar"}
        ...
        mockresp.json.return_value = {"responseHeader": {"status": 0, "QTime": 0}}
        ...
        mockresp.status_code = 200
        mockresp.json.return_value = {"responseHeader": {"status": 0, "QTime": 0}}
        response = client_base.make_request("post", "http://localhost/", wrap=False)
